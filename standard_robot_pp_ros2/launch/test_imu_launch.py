...
def generate_launch_description():
    ...
    # Disable log file creation to avoid read-only filesystem issues
    disable_log_file_envvar = SetEnvironmentVariable("ROS_LOG_DIR", "/tmp/ros/log")
    ...
    ld.add_action(disable_log_file_envvar)
    ...
    for action in bringup_cmd_group:
